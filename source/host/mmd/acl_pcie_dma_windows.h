...
class ACL_PCIE_DMA
{
   ...
   private:
      ...
      struct HOSTCH_DESC {
          ...
          WD_DMA *push_page_table_addr;
          WD_DMA *pull_page_table_addr;
      ...
      int            hostch_buffer_lock(void *addr, size_t len, PINNED_MEM *new_mem, int direction);
      void           poll_wait();
      ...
      // First dma page info
      WD_DMA_PAGE m_first_page;
      UINT32 m_remaining_first_page;
      
      // Local copy of last transfer id. Read once when DMA transfer starts
      UINT32 m_last_id;
      
      // Current transaction
      unsigned int m_handle_last;
      ...
      std::queue< WD_DMA* >                m_dma_unpin_pending;

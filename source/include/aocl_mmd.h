...
typedef enum {
   ...
   //eyoh
   AOCL_MMD_NUM_PARTITIONS = 9,         /* Number of partitions on the board (int) */
} aocl_mmd_info_t;
 ...
 */
AOCL_MMD_CALL int aocl_mmd_reprogram( int dev_handle, void * user_data , size_t size, int part_handle) WEAK;
